...
#include "ui_ajout_ouvrier.h"
#include <QMessageBox>

Ajout_ouvrier::Ajout_ouvrier(QWidget *parent,Institution*institution) :
    QMainWindow(parent),
    ui(new Ui::Ajout_ouvrier)
{
    ui->setupUi(this);
    this->institution=institution;
}

Ajout_ouvrier::~Ajout_ouvrier()
{
    delete ui;
}

void Ajout_ouvrier::on_pushButton_clicked()
{
