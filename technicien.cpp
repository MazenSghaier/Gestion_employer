...
#include "ui_technicien.h"
#include <QMessageBox>

Technicien::Technicien(QWidget *parent,Institution*institution) :
    QMainWindow(parent),
    ui(new Ui::Technicien)
{
    ui->setupUi(this);
...
void Technicien::on_pushButton_clicked()
{
    ...
    QMessageBox::information(this,"succées","L'employer a ajouté avec succé");
         ...
         Emp_Technicien r(e,45,3);
        institution->ajoute(r);
